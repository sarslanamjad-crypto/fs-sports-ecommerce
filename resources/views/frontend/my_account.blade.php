...
<div id="account-logged-in" class="hidden">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
    <a href="{{ route('wishlist.html') }}" class="bg-surface-container-low p-6 rounded-lg hover:bg-surface-container-high transition-all group">
    ...
    <a href="{{ route('cart_checkout.html') }}" class="bg-surface-container-low p-6 rounded-lg hover:bg-surface-container-high transition-all group">
    ...
    <a href="{{ route('shop_page.html') }}" class="bg-surface-container-low p-6 rounded-lg hover:bg-surface-container-high transition-all group">
...
<div id="account-logged-out" class="hidden text-center py-20">
  ...
  <a href="{{ route('login_signup.html') }}" class="px-12 py-4 bg-gradient-to-br from-primary to-error text-white shadow-[0_4px_10px_rgba(249,115,22,0.4)] hover:shadow-[0_6px_15px_rgba(249,115,22,0.6)] font-headline font-bold rounded-md hover:bg-primary-dim transition-all inline-block uppercase tracking-wider">Login / Sign Up</a>
</div>
</main>
...
async function logoutUser() {
  ...
  setTimeout(() => window.location.href = '{{ route("homepage.html") }}', 1000);
}
</script>
</body></html>
