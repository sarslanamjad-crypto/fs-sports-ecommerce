                                ...
                                <div class="col-xl-3">
                                    <div class="megamenu-items">
                                        ...
                                        <ul class="menu-list">
                                            ...
                                            <li class="active"><a href="1columns-right">1 Columns right sidebar</a></li>
                ...
                <div class="col-lg-12 d-flex justify-content-center">
                    <div class="banner-content style-2 text-center">
                        ...
                        <ul class="breadcrumb-list">
                            <li><a href="/">Home</a></li>
                            <li><span>/</span> 1 Columns Right Sidebar</li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-6">
                                            <div class="product-card-content">
                                                ...
                                                <h6><a class="hover-underline" href="product-details">Ultimate Comfort & Trendy
                                                        Design</a>
                                                </h6>
                                                <p class="price"><del>$345.00</del> $300.00 </p>
                                                <ul class="color-tag">
                                                ...
                                                <a href="product-details" class="primary-btn">Select options</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="product-card style-2">
                                    <div class="row g-4">
                                        <div class="col-lg-4 col-md-5 col-sm-6">
                                            <div class="product-card-img">
                                                <a href="product-details">
                                                    <img src="assets/image/inner-page/product-image2.png" alt="">
                                                </a>
                                                <div class="overlay"></div>
                                                <div class="view-and-favorite-area">
                                                    <ul>
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-6">
                                            <div class="product-card-content">
                                                ...
                                                <h6><a class="hover-underline" href="product-details">ultimate cozy chic oversize jacket</a>
                                                </h6>
                                                <p class="price"><del>$345.00</del> $300.00 </p>
                                                <ul class="size">
                                                    <li> XS</li>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-6">
                                            <div class="product-card-content">
                                                ...
                                                <h6><a class="hover-underline" href="product-details">The chicest oversized sweater</a>
                                                </h6>
                                                <p class="price"><del>$345.00</del> $300.00 </p>
                                                <a href="cart-page" class="primary-btn">ADD TO CART</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-6">
                                            <div class="product-card-content">
                                                ...
                                                <h6><a class="hover-underline" href="product-details">Stylish Relaxed Fit Shirt</a>
                                                </h6>
                                                <p class="price"><del>$345.00</del> $300.00 </p>
                                                <ul class="size">
                                                    <li> XS</li>
                        ...
                        <div class="single-widgets ">
                            ...
                            <div class="feature-product-area mb-20">
                                <div class="feature-product-image">
                                   <a href="product-details"> <img src="assets/image/inner-page/sidebar-product-image.png" alt=""></a>
                                </div>
                                <div class="feature-product-content">
                                    <h6><a href="product-details">Ultimate Comfort & Trendy Design</a></h6>
                                    <p>$150.00 <del>$200.00</del></p>
                                </div>
                            </div>
                            <div class="feature-product-area">
                                <div class="feature-product-image">
                                    <a href="product-details"><img src="assets/image/inner-page/sidebar-product-image2.png" alt=""></a>
                                </div>
                                <div class="feature-product-content">
                                    <h6><a href="product-details">Classic Navy Slim Fit Blazer</a></h6>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6 d-flex align-items-center">
                        <div class="foort-top-content">
                            ...
                            <a href="3columns-left" class="primary-btn">SHOP NOW</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="footer-button-area">
                <div class="row g-4 mb-100">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a class="primary-btn footer-btn" href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#a3cacdc5ccc6dbc2ced3cfc6e3c4cec2cacf8dc0ccce">
                            Email - <span class="__cf_email__" data-cfemail="21484f474e4459404c514d4461464c40484d0f424e4c">[email&#160;protected]</span>
                            <svg class="arrow" width="10" height="10" viewBox="0 0 10 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9"
                                    stroke="#1E1E1E" stroke-width="1.5" stroke-linecap="round"></path>
