...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
  ...
  <div class="lg:col-span-2">
    ...
    <div id="cart-empty" class="hidden col-span-full flex flex-col items-center justify-center text-center py-16">
      ...
      <a href="{{ route('shop_page.html') }}" class="inline-block mt-4 px-8 py-3 bg-gradient-to-br from-primary to-error text-white shadow-[0_4px_10px_rgba(249,115,22,0.4)] hover:shadow-[0_6px_15px_rgba(249,115,22,0.6)] font-label text-xs uppercase tracking-widest">Browse Shop</a>
    </div>
    <div id="cart-login" class="hidden col-span-full flex flex-col items-center justify-center text-center py-16">
      ...
      <a href="{{ route('login_signup.html') }}" class="inline-block mt-4 px-8 py-3 bg-gradient-to-br from-primary to-error text-white shadow-[0_4px_10px_rgba(249,115,22,0.4)] hover:shadow-[0_6px_15px_rgba(249,115,22,0.6)] font-label text-xs uppercase tracking-widest">Login / Sign Up</a>
    </div>
