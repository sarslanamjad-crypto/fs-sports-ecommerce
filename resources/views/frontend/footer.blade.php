...
<footer class="bg-[#000000] w-full pt-20 pb-10">
  <div class="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12 font-['Nunito'] text-sm">
    ...
    <div>
      ...
      <ul class="space-y-4">
        <li><a class="text-gray-500 hover:text-[#f97316] transition-colors" href="{{ route("homepage.html") }}">Home</a></li>
        <li><a class="text-gray-500 hover:text-[#f97316] transition-colors" href="{{ route("shop_page.html") }}">Shop</a></li>
        <li><a class="text-gray-500 hover:text-[#f97316] transition-colors" href="{{ route("my_account.html") }}">My Account</a></li>
        <li><a class="text-gray-500 hover:text-[#f97316] transition-colors" href="{{ route("cart_checkout.html") }}">Checkout</a></li>
      </ul>
    </div>
    <div>
      <h5 class="text-white font-headline font-bold mb-6 uppercase tracking-widest text-xs">More</h5>
      <ul class="space-y-4 text-gray-500">
        <li><a class="hover:text-[#f97316] transition-colors" href="{{ route('about_us.html') }}">About Us</a></li>
        <li><a class="hover:text-[#f97316] transition-colors" href="{{ route('store_locator.html') }}">Store Locator</a></li>
        <li><a class="hover:text-[#f97316] transition-colors" href="{{ route('wishlist.html') }}">Wishlist</a></li>
        <li><a class="hover:text-[#f97316] transition-colors" href="{{ route('faqs.html') }}">FAQs</a></li>
      </ul>
    </div>
    <div>
