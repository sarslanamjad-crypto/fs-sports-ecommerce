...
@section('title', 'Edit StaffManagement')
@section('main-container')
<div class="container-fluid"><br>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-info"><a class="text-info" href="{{ route('admin.staff-management.index') }}">StaffManagement List</a> | Edit StaffManagement #{{ $item->id }}</h6>
        </div>
        <div class="card-body">
            @if($errors->any())
