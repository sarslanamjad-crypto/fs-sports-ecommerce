...
@section('title', 'Add OnlinePaymentLog')
@section('main-container')
<div class="container-fluid"><br>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-info"><a class="text-info" href="{{ route('admin.online-payment-log.index') }}">OnlinePaymentLog List</a> | Add OnlinePaymentLog</h6>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            @endif
            <form action="{{ route('admin.online-payment-log.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
