...
<?php $__env->startSection('title', 'Add FinanceReport'); ?>
<?php $__env->startSection('main-container'); ?>
<div class="container-fluid"><br>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-info"><a class="text-info" href="<?php echo e(route('admin.finance-report.index')); ?>">FinanceReport List</a> | Add FinanceReport</h6>
        </div>
        <div class="card-body">
            <?php if($errors->any()): ?>
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('admin.finance-report.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CUI Data\6th Semester\Advance Web\AdvanceWebProject\resources\views\backend\finance-report\create.blade.php ENDPATH**/ ?>