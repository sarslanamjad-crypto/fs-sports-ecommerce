                        ...
                        <table class="table table-sm mb-0" style="border-collapse:separate;border-spacing:0 6px">
                            ...
                            <tbody>
                                <tr style="background:#f8fafc;border-radius:8px">
                                    ...
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalProjects); ?></td>
                                ...
                                <tr>
                                    ...
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalSuppliers); ?></td>
                                    <td style="border:0;padding:.75rem 1rem"><i class="fas fa-store mr-2" style="color:#06b6d4"></i>Branches</td>
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalBranches); ?></td>
                                    <td style="border:0;padding:.75rem 1rem"><i class="fas fa-industry mr-2" style="color:#64748b"></i>Manufacturers</td>
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalManufacturers); ?></td>
                                </tr>
                                <tr style="background:#f8fafc;border-radius:8px">
                                    ...
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalCustomers); ?></td>
                                    <td style="border:0;padding:.75rem 1rem"><i class="fas fa-box mr-2" style="color:#ec4899"></i>Products</td>
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalProducts); ?></td>
                                    ...
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalOrders); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
