...
<div x-data="{ cookiesAccepted: $persist(false) }">
  ...
  <a
    ...
    :style="'bottom: ' + (cookiesAccepted ? '1.5rem' : '5.5rem')"
    aria-label="Chat with us on WhatsApp"
    id="whatsapp-fab"
    @click="fetch('/api/frontend/whatsapp-click', { method: 'POST', headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' } })"
  >
...
<?php /**PATH D:\CUI Data\6th Semester\Advance Web\AdvanceWebProject\resources\views\frontend\footer.blade.php ENDPATH**/ ?>