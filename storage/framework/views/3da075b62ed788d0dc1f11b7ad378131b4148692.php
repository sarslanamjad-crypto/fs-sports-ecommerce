    ...
    <footer class="sticky-footer bg-gradient-info">
        <div class="container my-auto">
            <div class="copyright text-center my-auto text-white">
                <span>All Rights Reserved © <?php echo date('Y');?> | <a class="text-white" href="<?php echo e(config('app.url')); ?>"><?php echo e(config('app.name')); ?></a></span>
            </div>
        </div>
    </footer>
    ...
    <script src="<?php echo e(url('backend/js/datatables.js')); ?>"></script>
    ...
    <script src="<?php echo e(url('backend/js/form-script.js')); ?>"></script>
    <?php echo $__env->yieldPushContent('scripts'); ?>
    <?php echo $__env->make('components.loader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>
</html>
<?php /**PATH D:\CUI Data\6th Semester\Advance Web\AdvanceWebProject\resources\views\backend\layouts\footer.blade.php ENDPATH**/ ?>