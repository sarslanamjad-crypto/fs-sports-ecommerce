        ...
        <section class="py-32 bg-surface">
            <div class="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
                ...
                <div class="md:col-span-7 relative">
                    <div class="aspect-[4/5] bg-surface-container-highest relative overflow-hidden group">
                        <img class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-80"
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuCJ-YqyEAn9EmM_emLQlU9GpWUmmxxdtzEBJWjf2tLEtj1syzQ7_72i-Mr5cAxz9dtPd6U73I_jORQQjPi_7H54r5gsT-tYDyXlAN5WQXOnXJ5vf9Q6SQImsiQwIn1CA7CKsI1QxG2enilWz0nfZbmadGHjS75ttneZZ2lMM8dBPHuXOVioYQiq03GfjI0w2ZS4EtVJVl_Q30D9obswd_IqiPtpsSHdXBMpzIh4FNv8gB5PIoJl5pawJKs_7BQTUHNb6TsKKRX27SWv"
                            alt="Design Studio" />
                    ...
                    <div class="absolute -bottom-10 -left-10 hidden lg:block bg-primary p-10 max-w-sm shadow-2xl">
        ...
        <section class="py-32 bg-background">
            <div class="max-w-7xl mx-auto px-8">
                ...
                <div id="team-grid" class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <!-- Skeleton Loading -->
                    <div class="md:col-span-2 bg-surface-container-high h-96 skeleton-pulse"></div>
                    <div class="bg-surface-container-high h-64 skeleton-pulse"></div>
                    <div class="bg-surface-container-high h-64 skeleton-pulse"></div>
                </div>
            </div>
        </section>
                ...
                if (teamRes.success && teamRes.data && teamRes.data.length > 0) {
                    ...
                    teamRes.data.forEach((member, i) => {
                        ...
                        if (i === 0) {
                            // Featured large card
                            html += `
            <div class="md:col-span-2 bg-surface-container-high relative overflow-hidden group">
              ...
              <div class="absolute bottom-0 left-0 p-8 w-full bg-gradient-to-t from-black to-transparent">
                ...
                ${member.shortintro ? `<p class="text-on-surface-variant text-sm mt-2">${member.shortintro}</p>` : ''}
                            ...
                            // Standard cards
                            html += `
            <div class="md:col-span-1 bg-surface-container-high overflow-hidden group">
              ...
              <div class="p-6">
                ...
                <div class="flex gap-2 mt-3">
                  ...
                  ${member.twitter ? `<a href="${member.twitter}" class="text-on-surface-variant hover:text-primary text-xs" target="_blank">Twitter</a>` : ''}
                    ...
                    html += `
        <div class="md:col-span-1 bg-surface-container-high overflow-hidden group">
          <div class="p-8 h-full flex flex-col justify-between border border-outline-variant/20 hover:border-primary/40 transition-colors">
            <span class="material-symbols-outlined text-primary text-4xl">diversity_3</span>
            <div class="mt-12">
              <h4 class="font-headline text-lg font-bold">Join the Lab</h4>
              <p class="font-body text-xs text-on-surface-variant mt-2 leading-relaxed">We are always looking for kinetic thinkers and high-speed creators.</p>
              <a class="inline-block mt-4 font-label text-[10px] uppercase tracking-widest text-primary hover:underline underline-offset-4" href="mailto:careers@fssports.com?subject=Application%20for%20Open%20Position">Open Positions</a>
            </div>
          </div>
        </div>`;
...
<?php /**PATH D:\CUI Data\6th Semester\Advance Web\AdvanceWebProject\resources\views\frontend\about_us.blade.php ENDPATH**/ ?>