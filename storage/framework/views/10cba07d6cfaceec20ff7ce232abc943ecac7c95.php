    ...
    <section class="relative h-[921px] w-full overflow-hidden flex items-center">
      <div class="absolute inset-0 z-0">
        <img alt="High Performance Athlete" class="w-full h-full object-cover grayscale brightness-50 contrast-125"
          src="<?php echo e(asset('assets/image/hero.jpeg')); ?>" />
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-8 w-full">
        <div class="max-w-2xl">
          ...
          <div class="flex gap-4">
            <a href="<?php echo e(route('shop_page.html')); ?>"
            ...
            <a href="<?php echo e(route('about_us.html')); ?>"
    ...
    <section class="py-24 bg-surface-container-lowest">
      <div class="max-w-7xl mx-auto px-8">
        <div class="flex justify-between items-end mb-12">
          ...
          <a class="font-label text-primary hover:underline transition-all" href="<?php echo e(route('shop_page.html')); ?>">EXPLORE ALL GEAR →</a>
        </div>
        <!-- Dynamic Product Grid -->
        <div id="featured-products-grid" class="grid grid-cols-1 md:grid-cols-4 gap-6">
          <?php $__empty_1 = true; $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            ?>
            <div class="<?php echo e($gridClass); ?> relative group overflow-hidden rounded-xl cursor-pointer <?php echo e($minHeight); ?>"
                 style="background:linear-gradient(135deg,#1a1a1a,#0a0a0a);"
                 onclick="window.location.href='/product/<?php echo e($product->id); ?>'">

              <!-- Background Image (Animated on Hover) -->
              <img alt="<?php echo e($product->title); ?>" class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 opacity-80"
                   <?php if(Str::startsWith($product->image, ['http://', 'https://'])): ?>
              ...
              <div style="display:none;background:linear-gradient(135deg,#111,#1a1a1a);" class="absolute inset-0 items-center justify-center">
                  <span style="color:#f97316;font-size:3rem;font-weight:900;"><?php echo e($initials); ?></span>
              </div>
              ...
              <div class="absolute top-4 left-4 flex gap-2 z-10">
                <span class="bg-tertiary text-on-tertiary font-label text-[10px] px-2 py-0.5 uppercase font-bold rounded-sm shadow-lg">
                  <?php echo e($i === 0 ? 'Featured' : 'New Drop'); ?>

                </span>
                <?php if($product->is_in_house_brand == 1): ?>
              ...
              <?php if($isDiscounted): ?>
                <span class="bg-gradient-to-r from-orange-500 to-red-600 text-white font-headline font-black text-xs px-3 py-1.5 uppercase rounded shadow-lg tracking-wider absolute top-4 right-4 z-10"><?php echo e($product->discount_percentage); ?>% OFF</span>
              <?php endif; ?>
              ...
              <div class="absolute bottom-6 left-6 right-6 z-10">
                <p class="font-label text-primary font-bold text-[10px] uppercase tracking-widest mb-1 shadow-sm font-black drop-shadow-[0_1px_1px_rgba(0,0,0,0.8)]">
                  <?php echo e($product->category ? $product->category->title : 'Performance Gear'); ?>
                ...
                <div class="flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span class="font-headline font-bold text-primary text-xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] flex items-center gap-2">
                      <?php if($isDiscounted): ?>
                        Rs. <?php echo e(number_format($product->discounted_price, 0, '.', '')); ?> <span class="text-slate-400 line-through text-xs font-normal">Rs. <?php echo e(number_format($product->price, 0, '.', '')); ?></span>
                      <?php else: ?>
                        Rs. <?php echo e(number_format($product->price, 0, '.', '')); ?>

                      <?php endif; ?>
                  </span>
                  <button onclick="event.stopPropagation(); addToCartHandler(<?php echo e($product->id); ?>)"
          ...
          <div class="relative">
            <div class="aspect-square bg-surface-container-low rounded-lg overflow-hidden border border-white/5">
              <img alt="FS Workshop" class="w-full h-full object-cover"
                src="<?php echo e(asset('assets/HomePage.jpg')); ?>" />
            </div>
...
<?php /**PATH D:\PerfectProjects\FS Sports Ecommerce\resources\views/frontend/homepage.blade.php ENDPATH**/ ?>