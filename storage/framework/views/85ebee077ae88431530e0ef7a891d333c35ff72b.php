    ...
    <section class="relative h-[921px] w-full overflow-hidden flex items-center">
      <div class="absolute inset-0 z-0">
        <img alt="High Performance Athlete" class="w-full h-full object-cover grayscale brightness-50 contrast-125"
          src="<?php echo e(asset('assets/image/hero.avif')); ?>" />
    ...
    <section class="py-24 bg-surface-container-lowest">
      <div class="max-w-7xl mx-auto px-8">
        ...
        <div id="featured-products-grid" class="grid grid-cols-1 md:grid-cols-4 gap-6">
          <!-- Skeleton Loading -->
          <div class="md:col-span-2 md:row-span-2 bg-surface-container-low rounded-lg h-[500px] skeleton-pulse"></div>
          <div class="bg-surface-container-low p-6 h-[240px] skeleton-pulse"></div>
          <div class="bg-surface-container-low p-6 h-[240px] skeleton-pulse"></div>
          <div class="bg-surface-container-low p-6 h-[240px] col-span-1 md:col-span-2 skeleton-pulse"></div>
        </div>
      </div>
    </section>
          ...
          <div>
            ...
            <div class="space-y-10">
              <div class="flex gap-6">
                ...
                <div>
                  <h4 class="font-headline font-bold text-xl mb-2">The FS Bat Series</h4>
                  <p class="font-body text-on-surface-variant">Hand-crafted from English Willow, optimized for balance
                    and explosive power. Used by professionals worldwide.</p>
                </div>
              </div>
              <div class="flex gap-6">
                ...
                <div>
                  <h4 class="font-headline font-bold text-xl mb-2">The FS Bowls Program</h4>
                  <p class="font-body text-on-surface-variant">Scientific weight distribution meets traditional
                    craftsmanship. Elevate your delivery precision.</p>
                </div>
              </div>
            </div>
            <a href="<?php echo e(route('shop_page.html')); ?>"
          ...
          <div class="relative">
            <div class="aspect-square bg-surface-container-low rounded-lg overflow-hidden border border-white/5">
              <img alt="FS Workshop" class="w-full h-full object-cover"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuB119MsUjTESK7X_KKFaHzWmrfiehG9T4hGuJ7XK6QzNNEejhlczqSGta0DNGx-10ZQ3to7V0S1gQQE7n87RVVu9YY9sfWGrFdmTOhJG5FfYpnx7xPN77BJ4kO6cLSIjoy0eSa06RSfWKpGOtc9dcXr5-XNWjq87FAzWxg8ltn7CizJ50F_OTsz-BblW53je5pGxCJMtSSchpl9ZTrafqzNOz8u7kGU2UaWhcEpUf_7Z0EEHgED3DRjRherK2oDOr9ViTyUYTQ29SvO" />
            </div>
      ...
      try {
        ...
        if (res.success && res.data && res.data.length > 0) {
          ...
          res.data.forEach((product, i) => {
            ...
            html += `
              <div class="${gridClass} relative group overflow-hidden rounded-lg cursor-pointer ${minHeight}"
...
<?php /**PATH D:\CUI Data\6th Semester\Advance Web\AdvanceWebProject\resources\views\frontend\homepage.blade.php ENDPATH**/ ?>