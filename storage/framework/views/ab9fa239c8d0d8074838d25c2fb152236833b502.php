<?php $__env->startSection('title', 'Dashboard — FS Sports'); ?>
...
<div class="container-fluid py-3">
    ...
    <div class="row mb-2">
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <a href="<?php echo e(route('admin.finance-report.index')); ?>" class="text-decoration-none" style="display: block; color: inherit;">
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <a href="<?php echo e(route('admin.orders-transaction.index')); ?>" class="text-decoration-none" style="display: block; color: inherit;">
                <div class="card kpi-card shadow h-100" style="cursor: pointer;">
                    <div class="card-body d-flex align-items-center">
            ...
            <div class="card kpi-card shadow h-100">
                <div class="card-body p-2 d-flex flex-column h-100">
                    ...
                    <div class="grid grid-cols-3 gap-1.5 flex-grow-1 items-center">
                        <!-- Left: Pending Orders -->
                        <a href="<?php echo e(route('admin.orders-transaction.index', ['status' => 'pending'])); ?>" class="text-decoration-none" style="display: block; color: inherit; height: 100%;">
                        ...
                        <a href="<?php echo e(route('admin.orders-transaction.index', ['status' => 'confirmed'])); ?>" class="text-decoration-none" style="display: block; color: inherit; height: 100%;">
                        ...
                        <a href="<?php echo e(route('admin.orders-transaction.index', ['status' => 'delivered'])); ?>" class="text-decoration-none" style="display: block; color: inherit; height: 100%;">
        ...
        <div class="col-xl-3 col-md-6 mb-3">
            <a href="<?php echo e(route('admin.products-inventory.index', ['filter' => 'low_stock'])); ?>" class="text-decoration-none" style="display: block; color: inherit;">
                <div class="card kpi-card shadow h-100" style="cursor: pointer;">
                    <div class="card-body d-flex align-items-center">
    ...
    <div class="row mb-2">
        ...
        <?php $__currentLoopData = $miniStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-xl-3 col-md-6 mb-3">
            <a href="<?php echo e($ms['url']); ?>" class="text-decoration-none" style="display: block; color: inherit;">
                <div class="card stat-mini shadow-sm h-100" style="cursor: pointer;">
                    <div class="card-body d-flex align-items-center py-3">
                        <div class="stat-icon mr-3" style="background:<?php echo e($ms['bg']); ?>;color:<?php echo e($ms['clr']); ?>"><i class="<?php echo e($ms['icon']); ?>"></i></div>
                        <div>
                            <div style="font-size:.7rem;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#94a3b8"><?php echo e($ms['label']); ?></div>
                            <div style="font-size:1.25rem;font-weight:800;color:#1e293b"><?php echo e($ms['val']); ?></div>
                        </div>
                    </div>
                </div>
            </a>
                        ...
                        <table class="table table-sm mb-0" style="border-collapse:separate;border-spacing:0 6px">
                            ...
                            <tbody>
                                <tr style="background:#f8fafc;border-radius:8px">
                                    ...
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalAdmins); ?></td>
                                    <td style="border:0;padding:.75rem 1rem"><i class="fas fa-project-diagram mr-2" style="color:#6366f1"></i>Projects</td>
                                    <td style="border:0;border-radius:0 8px 8px 0;font-weight:800" class="text-center"><?php echo e($TotalProjects); ?></td>
                                </tr>
                                <tr><td style="border:0;padding:.75rem 1rem"><i class="fas fa-question-circle mr-2" style="color:#10b981"></i>FAQs</td>
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalFAQs); ?></td>
                                    <td style="border:0;padding:.75rem 1rem"><i class="fas fa-address-book mr-2" style="color:#f59e0b"></i>Contacts</td>
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalContacts); ?></td>
                                </tr>
                                <tr style="background:#f8fafc;border-radius:8px">
                                    <td style="border:0;border-radius:8px 0 0 8px;padding:.75rem 1rem"><i class="fas fa-user mr-2" style="color:#06b6d4"></i>Users</td>
                                    <td style="border:0;font-weight:800" class="text-center"><?php echo e($TotalUsers); ?></td>
                                    <td style="border:0;padding:.75rem 1rem"><i class="fas fa-envelope mr-2" style="color:#64748b"></i>Joinings</td>
                                    <td style="border:0;border-radius:0 8px 8px 0;font-weight:800" class="text-center"><?php echo e($whatsappJoiningsCount); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    function loadDashboard(range, startDate, endDate){
        ...
        var url = "<?php echo e(route('admin.dashboard-stats')); ?>";
...
<?php echo $__env->make('backend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CUI Data\6th Semester\Advance Web\AdvanceWebProject\resources\views\backend\index.blade.php ENDPATH**/ ?>