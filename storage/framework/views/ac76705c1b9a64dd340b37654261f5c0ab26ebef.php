        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion sticky top-0 h-screen overflow-y-auto" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(url('/admin')); ?>">
                <div class="sidebar-brand-icon ">
                    <img src="<?php echo e(url('assets/image/logo.png')); ?>" alt="logo" style="max-height: 80px; max-width: 100%;" />
                </div>
            </a>
            <br>
            ...
            <li class="nav-item">
                ...
                <div id="collapseAuth" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(url('/admin/register')); ?>">Add an Admin</a>
                        <a class="collapse-item" href="<?php echo e(url('/admin/admins-list')); ?>">Admin List</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCompany" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('admin.staff-management.index')); ?>">Staff Management</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.branch.index')); ?>">Branches Initiative</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseBrand" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('admin.supplier.index')); ?>">Suppliers</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.manufacturing-partner.index')); ?>">Manufacturing Partners</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCMS" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('admin.site-setting.index')); ?>">Site Settings/CMS</a>
                        <a class="collapse-item" href="<?php echo e(url('/admin/team')); ?>">Team Details</a>
                        <a class="collapse-item" href="<?php echo e(url('/admin/faqs')); ?>">FAQs</a>
                        <a class="collapse-item" href="<?php echo e(url('/admin/projects')); ?>">Projects Management</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCatalog" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('admin.products-inventory.index')); ?>">Products & Inventory</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseOrders" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('admin.customer.index')); ?>">Customers</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.orders-transaction.index')); ?>">Orders</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.shipping-detail.index')); ?>">Shipping</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.product-review.index')); ?>">Product Reviews</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e($Name ?? session('first_name') . ' ' . session('last_name')); ?></span>
                                <img class="img-profile rounded-circle" src="<?php echo e(url('backend/images/profile.svg')); ?>" alt="<?php echo e(config('app.name')); ?>">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?php echo e(route('admin.edit', ['id' => session('id')])); ?>">
...
<?php /**PATH D:\CUI Data\6th Semester\Advance Web\AdvanceWebProject\resources\views/backend/layouts/header.blade.php ENDPATH**/ ?>