<?php $__env->startSection('title', 'Add ProductsInventory'); ?>
<?php $__env->startSection('main-container'); ?>
<div class="container-fluid"><br>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-info"><a class="text-info" href="<?php echo e(route('admin.products-inventory.index')); ?>">ProductsInventory List</a> | Add ProductsInventory</h6>
        </div>
        <div class="card-body">
            <?php if($errors->any()): ?>
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('admin.products-inventory.store')); ?>" method="POST" enctype="multipart/form-data" onsubmit="triggerLoader()">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CUI Data\6th Semester\Advance Web\AdvanceWebProject\resources\views\backend\products-inventory\create.blade.php ENDPATH**/ ?>